...
const SponcersSection = () => {
   const Data = [
    { "_id": "user", "url": "https://i.ibb.co/5nt2WHc/brand-01-159x90-1.png" },
    { "_id": "brand02", "url": "https://i.ibb.co/G0HpDPv/brand-02-164x90-Copy.png" },
    { "_id": "brand03", "url": "https://i.ibb.co/59TxHVs/brand-03-124x90-1-Copy.png" },
    ...
    return (
        ...
        >
            {Data.map((item) => (
              <SwiperSlide key={item._id} className='border border-red-500 '>
                <img src={item.url} alt="" className='text-center  w-[60%] '  />
              </SwiperSlide>
            ))}
...
export default SponcersSection;
