...
const ServicesHero = () => {
  return (
    <div>
      ...
      <div className="card rounded-none grid xl:grid-cols-2 my-12   gap-[2%]  shadow-md md:p-5  ">
        <figure className="md:order-2">
          <img
            src="https://i.ibb.co/1TbBFxC/services-01-610x390.jpg"
            alt="Album"
            className="md:w-[90%] lg:w-[92%] w-full  xl:w-[86%] mx-auto  md:h-[45dvh] lg:[45dvh] xl:h-[42dvh]   "
          />
        </figure>
